...
#[Route('/api/director_affiliates')]
class DirectorAffiliatesController extends AbstractController
{
    #[Route('', name: 'api_director_affiliates_list', methods: ['GET'])]
    public function list(Request $request, AffiliatesRepository $affiliatesRepository): JsonResponse
    {
        ...
        $data = $affiliatesRepository->findBy([], [$sort => $order], $limit, $offset);
        $totalProducts = $affiliatesRepository->count([]);
        $totalPages = ceil($totalProducts / $limit);

        $resp_data = array_map(function($product) {
            return [
                'id' => $product->getId(),
                'address' => $product->getAddress(),
                'contact_number' => $product->getContactNumber(),
            ];
        }, $data);
    ...
    #[Route('/search', name: 'api_director_affiliates_search', methods: ['GET'])]
    ...
    #[Route('', name: 'api_director_affiliates_create', methods: ['POST'])]
    ...
    #[Route('/{id}', name: 'api_director_affiliates_update', methods: ['PATCH'])]
    ...
    #[Route('/{id}', name: 'api_director_affiliates_delete', methods: ['DELETE'])]
